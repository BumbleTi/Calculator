...
public static int arabNumber (String firstSecArab) //Публичный статический метод. Должно возвращаться число(int). Передаём строку (String)
    ...
    {
        int y = 0; // переменная для присвоения в операторе switch-case.
        switch (str2)
        {
            case "0": // В случае передачи строки "0", переменной присвоиться её числовое значение. И так по аналогии.
                y = 0;
                break;
            case "1":
                y = 1;
            ...
            case "10":
                ...
                break;
          //  default:
            //    System.out.println("Число выходит за диапозон возможности калькулятора");
