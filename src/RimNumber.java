class RimNumber{
    ...
    private static int saveRim (String str1)
    {
        ...
        switch (str1)
        {
            case "I": // В случае передачи строки "I", переменной присвоиться её числовое значение. И так по аналогии.
                x = 1;
                break;
            case "II":
                x = 2;
            ...
            case "X":
                ...
                break;
          //  default:
            //    System.out.println("В системе римских цифр отсутствует ноль");
        }
        return x;
    }
}
